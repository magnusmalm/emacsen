(custom-set-variables
 ...
 '(highlight-indent-guides-auto-top-odd-face-perc 20)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(ace-jump-face-foreground ((t (:background "#3F3F3F" :foreground "gold" :inverse-video nil))))
 ...
 '(highlight-indent-guides-odd-face ((t (:foreground "indian red"))))
 '(highlight-indent-guides-stack-character-face ((t nil)))
 '(highlight-indent-guides-stack-even-face ((t nil)))
 '(highlight-indent-guides-stack-odd-face ((t nil)))
 '(highlight-indent-guides-top-character-face ((t (:foreground "LightGoldenrod1"))))
 '(highlight-indent-guides-top-even-face ((t (:foreground "dark orange"))))
 '(highlight-indent-guides-top-odd-face ((t nil)))
 '(highlight-indentation-face ((t (:inherit fringe :family "Ariel"))))
 ...
 '(rainbow-delimiters-depth-6-face ((t (:foreground "yellow2"))))
 '(rainbow-delimiters-depth-7-face ((t (:foreground "SpringGreen3"))))
 '(rainbow-delimiters-depth-8-face ((t (:foreground "violet"))))
 '(rainbow-delimiters-depth-9-face ((t (:foreground "gold1"))))
 '(rainbow-delimiters-mismatched-face ((t (:background "black" :foreground "orange red"))))
 '(rainbow-delimiters-unmatched-face ((t (:inherit rainbow-delimiters-base-face :background "black" :foreground "red"))))
